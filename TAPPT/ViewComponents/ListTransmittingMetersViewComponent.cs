...
{
    public class ListTransmittingMetersViewComponent : ViewComponent
    {
        private readonly IConfiguration _configuration;
        public ListTransmittingMetersViewComponent(IConfiguration configuration)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync(int id)
        {
            ...
            var urlString = baseUrl + "admin/WSPTransmittingMeters/" + id;
