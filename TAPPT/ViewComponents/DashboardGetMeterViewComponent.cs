...
{
    public class DashboardGetMeterViewComponent : ViewComponent
    {
        private readonly IConfiguration _configuration;
        public DashboardGetMeterViewComponent(IConfiguration configuration)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync(int id)
        {
            ...
            var urlString = baseUrl + "admin/DashboardGetMeter/" + id;
