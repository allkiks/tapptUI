...
{
    public class TransmittingMeterViewComponent : ViewComponent
    {
        private readonly IConfiguration _configuration;
        public TransmittingMeterViewComponent(IConfiguration configuration)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync(int id)
        {
            ...
            var urlString = baseUrl + "admin/GetMeter/"+ id;
